...
function addItem(item){
	...
	div.className = 'item';
	div.innerHTML = "<div class ='well'><img width='100%' height='auto' src = '"+item.imgsrc+"'/><br><button onclick='orderItem(\""+item._id+"\")'><b>Buy me</b></button><br><u>"+item.name+"</u><br>"+item.description+"<br><b>$"+item.usaDollarPrice + "</b></div>";
...
<table class="headerTable">
	<tr>
		<td><span class="pageTitle"><h1>Microservices Sample aws-github </h1></span></td> 
	</tr>
</table>
